...
import pytest
from conftest import FAKE_AWS_KEY_ID, FAKE_AWS_SECRET, FAKE_GITHUB_TOKEN, FAKE_GOOGLE_API_KEY

from supervisor import sensitive
from supervisor.sensitive import iban_valid, luhn_valid, nhs_valid, nino_valid, scan, ssn_valid
