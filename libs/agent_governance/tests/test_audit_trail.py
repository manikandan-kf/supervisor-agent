"""The evidence trail: what is recorded, and that it cannot be altered undetectably.

The sink is the record; the hash chain is what makes it evidence.
"""
...
import pytest
from agent_governance.audit_trail import (
    LoggingAuditLogger,
    PostgresAuditLogger,
    TracingAuditLogger,
    verify_chain,
