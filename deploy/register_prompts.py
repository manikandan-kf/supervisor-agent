...
script publishes them as the initial registered version.
    ...
    python deploy/register_prompts.py                 # register + alias
    python deploy/register_prompts.py --dry-run       # show what would happen
    python deploy/register_prompts.py --alias prod    # promote to another alias
    python deploy/register_prompts.py --pin 1         # roll the alias back to v1
